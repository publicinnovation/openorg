...
<div class="container bs-docs-container">
  <div class="row">
    ...
    <div class="col-md-9" role="main">
      ...
      <!-- Social Impact Model Diagram
      ================================================== -->
      <div class="bs-docs-section">

        <div class="page-header">
          <h1 id="diagram">Social Impact Model Diagram</h1>
        </div>
        ...
        <ul>
          ...
          <li>Number of total projects initiated</li>
        </ul>
      ...
      <div class="bs-docs-section">
        ...
        <div class="page-header">
          <h1 id="operating">Description of Operating Model</h1>
        </div>
      ...
      <div class="bs-docs-section">
        ...
        <div class="page-header">
          <h1 id="strategies">Description of Social Impact Strategies</h1>
        </div>

        <h3 id="strategies-platform-for-co-creation">Platform for co-creation</h3>
        <h3 id="strategies-culture-first">Culture first</h3>
        <h3 id="strategies-storytelling">Platform</h3>
        <h3 id="strategies-capacity-building">Capacity building</h3>
      </div>
