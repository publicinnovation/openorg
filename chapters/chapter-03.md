...
Because so much of the work of innovation requires a networked approach, we must create the spaces in which individuals and organizations can not only connect with each other, but also have a keen understanding of who’s doing what. This helps to avoid duplication of effort and ensures added value is consistently being contributed across the larger ecosystem.
		...
		1. Civic and Social Innovation Ecosystem
...
Source: http://www.kauffman.org/newsroom/entrepreneur-guru-brad-feld-illustrates-how-to-build-a-startup-community-in-new-kauffman-sketchbook-video.aspx#sthash.YoBh88QU.dpuf
...
3. CO-PRODUCTION: Supporting the Development of Civic Innovations
...
4. INTRAPRENEURSHIP: Giving Public Servants and Nonprofit Leaders the Tools to Evangelize Change
